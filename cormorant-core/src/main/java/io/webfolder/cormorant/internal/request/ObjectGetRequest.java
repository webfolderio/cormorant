...
public class ObjectGetRequest {
    ...
    /**
     * <p>Overrides the default file name. Object Storage generates a default file name for GET temporary URLs that is based on the object name. Object Storage returns this value in the {@literal Content-Disposition} response header. Browsers can interpret this file name value as a file attachment to save. For more information about temporary URLs, see `Temporary URL middleware &lt;<a href="http://docs.openstack.org/developer">http://docs.openstack.org/developer</a>/ swift/api/temporary_url_middleware.html&gt;`_.</p>
     */
