...
public class ObjectDeleteRequest {
    ...
    /**
     * <p>If you include the {@literal multipart-manifest=delete} query parameter and the object is a static large object, the segment objects and manifest object are deleted. If you omit the {@literal multipart-manifest=delete} query parameter and the object is a static large object, the manifest object is deleted but the segment objects are not deleted.  The response body will contain the status of the deletion of every processed segment object.</p>
     */
