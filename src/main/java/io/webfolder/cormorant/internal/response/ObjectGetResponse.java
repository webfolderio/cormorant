...
public class ObjectGetResponse implements CormorantResponse {
    ...
    /**
     * <p>The length of the object content in the response body, in bytes.</p>
     */
    ...
    /**
     * <p>If present, the custom object metadata item, where {@literal name} is the name of the metadata item.  One{@literal X-Object-Meta-name} response header appears for each metadata {@literal name} item.</p>
     */
